...
from libs.processing.define import get_raw_columns,get_feature_base_columns
from conf.conf import ZAMPLUS_RTB_ALL_URL
from conf.conf import RTB_ALL_TABLE_NAME, RTB_LOCAL_TABLE_NAME

from datetime import datetime
from pyspark.sql.functions import broadcast
from libs.processing import udfs
from libs.processing.define import user_cap_feature
...
def extend_rtb_data(spark, raw):
    ...
    # extract cap imp & bidding imp from ext_dict
