...
from libs.model.predictor.predictor import Predictor


class  TFLRPredictor(Predictor):
    ...
    def predict(self,  worker_num, input_dim, data_names):
        ...
        for name in data_names:
            ...
            hdfs_path = os.path.join(self._hdfs_dir, result_name)
            local_path = os.path.join(self._local_dir, result_name)
    ...
    def _evaluate_auc(self, data_name):
        root_dir = os.path.join(self._local_dir, data_name)
    ...
    def get_worker_entrance():
        from libs.model.predictor.tflr.worker import main_fun_name
