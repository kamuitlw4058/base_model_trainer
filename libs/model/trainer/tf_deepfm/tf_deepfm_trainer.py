...
class TF_DeepFM_Trainer(Trainer):
    ...
    def train(self, epoch,batch_size,worker_num,input_dim, data_name):
        ...
        model.from_checkpoint(local_ckpt_dir)
        return model
    ...
    def print_features_weight(self,features_list):
        pass
        # lr = DeepFM(input_dim=self._input_dim)
    ...
    def get_worker_entrance():
        from libs.model.trainer.tf_deepfm.worker import main_fun_name
